...
var _ resourceid.Formatter = CreatorId{}
...
func TestCreatorID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Maps/accounts/account1/creators/",
			Error: true,
		},
