...
func (r StorageContainerImmutabilityPolicyResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			_, err = client.BlobContainersCreateOrUpdateImmutabilityPolicy(ctx, *containerId, input, immutabilitypolicies.DefaultBlobContainersCreateOrUpdateImmutabilityPolicyOperationOptions())
			if err != nil {
...
func (r StorageContainerImmutabilityPolicyResource) Update() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			_, err = client.BlobContainersCreateOrUpdateImmutabilityPolicy(ctx, *containerId, input, options)
			if err != nil {
