...
var _ resourceids.Id = StorageAccountCustomDomainId{}

func TestStorageAccountCustomDomainIDFormatter(t *testing.T) {
	actual := NewStorageAccountCustomDomainID("12345678-1234-9876-4563-123456789012", "resGroup1", "storageAccount1", "domain1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Storage/storageAccounts/storageAccount1/customDomains/domain1"
	if actual != expected {
		t.Fatalf("Expected %q but got %q", expected, actual)
	}
}

func TestStorageAccountCustomDomainID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *StorageAccountCustomDomainId
	}{
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Storage/storageAccounts/storageAccount1/customDomains/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Storage/storageAccounts/storageAccount1/customDomains/domain1",
			Expected: &StorageAccountCustomDomainId{
	...
	for _, v := range testData {
		...
		actual, err := StorageAccountCustomDomainID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
