...
func getMySQLServerKeyName(ctx context.Context, keyVaultsClient *client.Client, argClient *resourceGraphClient.Client, keyVaultKeyURI string) (*string, error) {
...
func resourceMySQLServerKeyCreateUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	name, err := getMySQLServerKeyName(ctx, keyVaultsClient, argClient, keyVaultKeyURI)
	if err != nil {
